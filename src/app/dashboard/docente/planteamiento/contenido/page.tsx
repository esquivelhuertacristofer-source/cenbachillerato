        ...
        <div style={{ flex: 1, overflowY: 'auto', background: '#F4F1EA' }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <Link
                href="/dashboard/docente/planteamiento"
                style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 12, fontWeight: 700, color: 'rgba(11,37,69,0.55)', textDecoration: 'none' }}
              >
                <ArrowLeft style={{ width: 14, height: 14 }} />
                Seguimiento
              </Link>
              <span style={{ color: 'rgba(11,37,69,0.2)', fontSize: 14 }}>·</span>
