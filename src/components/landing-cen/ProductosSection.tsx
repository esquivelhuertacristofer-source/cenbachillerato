...
export const PRODUCTS: ProductItem[] = [
  ...
  },
  {
    ...
    description: 'Plataforma alineada al Marco Curricular Común de la EMS. 32 UAC del Currículum Fundamental, 8 RSC y 4 Ámbitos de Formación.',
    meta: '32 UAC · 6 Semestres',
    icon: 'fa-graduation-cap',
    color: 'linear-gradient(135deg, #0A1628 0%, #1E3A8A 100%)',
    accent: '#3B82F6',
    features: ['32 UAC', '8 RSC', 'MCCEMS 2025', 'Multi-subsistema'],
    image: '/bachillerato.webp',
    href: '/bachillerato',
    available: true,
    telemetry: [
      { val: '32 UAC', lbl: 'SEP Oficial',    icon: 'fa-book-open'    },
      { val: '100%',   lbl: 'MCCEMS 2025',    icon: 'fa-check-circle' },
