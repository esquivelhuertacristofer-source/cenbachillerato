  ...
  return (
    <div className="flex min-h-screen bg-[#011C40] font-['Epilogue']">
      ...
      <main className="flex-1 p-4 sm:p-8 md:p-12 space-y-8">
        <div className="animate-pulse h-8 w-36 rounded-lg bg-white/[0.07]" />
        <div className="space-y-4">
          {[1, 2, 3].map((i) => (
            <div key={i} className="animate-pulse h-24 rounded-2xl bg-white/[0.05] border border-white/[0.06]" />
          ))}
        </div>
      </main>
    </div>
