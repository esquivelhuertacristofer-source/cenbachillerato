...
const contenidosA2 = [
    ...
    preguntas: [
      {
        ...
        opciones: [
          { id: "a", texto: "La descriptiva usa graficas y la inferencial solo usa numeros" },
          { id: "b", texto: "La descriptiva resume y organiza los datos observados sin ir mas alla; la inferencial usa una muestra para sacar conclusiones sobre una poblacion mas grande" },
          { id: "c", texto: "La descriptiva es para datos cualitativos y la inferencial para datos cuantitativos" },
          { id: "d", texto: "Son identicas; solo tienen nombres distintos segun el contexto en que se usan" },
        ],
      ...
      },
      {
        ...
        opciones: [
          { id: "a", texto: "Numero de hijos en el hogar" },
          { id: "b", texto: "Nivel educativo (primaria, secundaria, bachillerato)" },
          { id: "c", texto: "Ingreso mensual en pesos del jefe de hogar" },
          { id: "d", texto: "Municipio de residencia del encuestado" },
        ],
      ...
      },
      {
        ...
        opciones: [
          { id: "a", texto: "La inflacion mensual usando precios de la canasta basica" },
          { id: "b", texto: "La pobreza multidimensional, usando datos de la ENIGH del INEGI sobre ingresos y acceso a servicios" },
          { id: "c", texto: "El desempleo trimestral mediante la ENOE" },
          { id: "d", texto: "Las proyecciones de poblacion futura por estado y municipio" },
        ],
        respuesta_correcta: "b",
      ...
      },
      {
        ...
        opciones: [
          { id: "a", texto: "La poblacion son los encuestadores y la muestra son las preguntas del cuestionario" },
          { id: "b", texto: "La poblacion es el conjunto completo de todos los elementos de interes (todos los hogares mexicanos); la muestra es el subconjunto seleccionado para ser encuestado" },
          { id: "c", texto: "La poblacion es la muestra mas grande y la muestra es la poblacion mas pequeña; son lo mismo con diferente nombre" },
          { id: "d", texto: "La poblacion solo aplica al Censo y la muestra solo a encuestas urbanas" },
        ],
        respuesta_correcta: "b",
      ...
      },
      {
        ...
        opciones: [
          { id: "a", texto: "Porque el INEGI les hace cuestionarios mas cortos para ahorrar tiempo" },
          { id: "b", texto: "Porque comunidades en zonas de dificil acceso, personas en situacion de calle y migrantes irregulares son mas dificiles de alcanzar con los metodos de levantamiento estandar, generando sesgos de representacion" },
          { id: "c", texto: "Porque esas personas no tienen derecho a participar en las encuestas nacionales" },
          { id: "d", texto: "Porque el INEGI deliberadamente los excluye para mejorar las estadisticas de pobreza" },
        ],
        respuesta_correcta: "b",
      ...
      },
      {
        ...
        opciones: [
          { id: "a", texto: "Invento la formula para calcular la media aritmetica en 1858" },
          { id: "b", texto: "Uso graficas innovadoras de causas de muerte durante la guerra de Crimea para convencer al Parlamento britanico de que las condiciones sanitarias, no las batallas, eran la principal causa de muerte entre soldados" },
          { id: "c", texto: "Fundo el primer departamento de estadistica oficial de Gran Bretana en el siglo XIX" },
          { id: "d", texto: "Publico las primeras tablas de mortalidad de Londres en 1662" },
        ],
        respuesta_correcta: "b",
  ...
  { // P02 — ejercicio_matematico (tabla de frecuencias, frecuencia relativa acumulada, ojiva)
    ...
    solucion_numerica: 100,
    tolerancia: 0,
    unidad: "% (frecuencia relativa acumulada del ultimo intervalo)",
  ...
  { // P03 — ejercicio_matematico (media y mediana, efecto de outliers, salarios)
    enunciado: "Los salarios mensuales (en pesos) de 9 empleados de una empresa son: 6,500, 7,200, 7,800, 8,000, 8,500, 9,000, 10,000, 12,000 y 45,000. Calcula la media aritmetica y la mediana. Luego determina cual de las dos medidas representa mejor el salario tipico de estos 9 empleados.",
    ...
    solucion_numerica: 8500,
    tolerancia: 0,
    unidad: "pesos (mediana)",
  ...
  { // P04 — ejercicio_matematico (varianza y desviacion estandar del Grupo A)
    enunciado: "Dos grupos de 5 estudiantes tienen la siguiente media de calificaciones: Grupo A: 60, 70, 75, 80, 90 y Grupo B: 73, 74, 75, 76, 77. Ambos grupos tienen la misma media (x_barra = 75). Calcula la varianza y la desviacion estandar del Grupo A para determinar que tan dispersas estan sus calificaciones.",
    ...
    solucion_numerica: 10,
    tolerancia: 0.1,
    unidad: "puntos (desviacion estandar del Grupo A)",
    ...
    preguntas: [
      {
        ...
        opciones: [
          { id: "a", texto: "P(A) = frecuencia de A en muchas repeticiones; requiere un numero grande de experimentos" },
          { id: "b", texto: "P(A) = numero de casos favorables a A / numero total de casos posibles; requiere que todos los resultados sean igualmente posibles (equiprobabilidad)" },
          { id: "c", texto: "P(A) = grado de creencia subjetiva en A; no requiere ningun supuesto matematico" },
          { id: "d", texto: "P(A) = 1 - P(A'); requiere conocer la probabilidad del complemento de A" },
        ],
        respuesta_correcta: "b",
      ...
      },
      {
        ...
        opciones: [
          { id: "a", texto: "Que con mas datos la media siempre aumenta" },
          { id: "b", texto: "Que conforme aumenta el numero de repeticiones del experimento, la frecuencia relativa del evento converge al valor verdadero de la probabilidad" },
          { id: "c", texto: "Que en un juego de azar siempre recuperas lo perdido si juegas suficientes veces" },
          { id: "d", texto: "Que la muestra siempre tiene exactamente las mismas proporciones que la poblacion" },
        ],
        respuesta_correcta: "b",
      ...
      },
      {
        ...
        opciones: [
          { id: "a", texto: "P(A) esta entre -1 y 1; P(vacio) = 0; P(A union B) = P(A) x P(B)" },
          { id: "b", texto: "P(A) es mayor o igual a 0; P(espacio muestral) = 1; si A y B son mutuamente excluyentes, P(A union B) = P(A) + P(B)" },
          { id: "c", texto: "P(A) esta entre 0 y 100; P(espacio muestral) = 100; P(A interseccion B) = P(A) + P(B)" },
          { id: "d", texto: "P(A) = P(A'); P(espacio muestral) = 0.5; P(A union B) = P(A) - P(B)" },
        ],
        respuesta_correcta: "b",
      ...
      },
      {
        ...
        opciones: [
          { id: "a", texto: "La probabilidad de sacar un 6 al lanzar un dado justo es 1/6" },
          { id: "b", texto: "La probabilidad de que un recien nacido sea nino es 0.51 segun los registros del INEGI" },
          { id: "c", texto: "El medico dice: 'Dados tus sintomas y tu historial, yo diria que hay un 70% de probabilidad de que sea una infeccion viral'" },
          { id: "d", texto: "El pronostico del tiempo dice que hay 40% de probabilidad de lluvia basado en modelos de los ultimos 30 anos" },
        ],
        respuesta_correcta: "c",
      ...
      },
      {
        ...
        opciones: [
          { id: "a", texto: "El INEGI decide cuantos empleados contratar para el proximo censo" },
          { id: "b", texto: "La SSA estima probabilidades de contagio de enfermedades infecciosas para decidir cuantas vacunas producir y distribuir antes de una temporada de influenza" },
          { id: "c", texto: "Un estudiante decide en que universidad estudiar segun su promedio de preparatoria" },
          { id: "d", texto: "Un maestro decide cuantas preguntas poner en un examen" },
        ],
        respuesta_correcta: "b",
  ...
  { // P06 — ejercicio_matematico (VPP con teorema de Bayes, prueba de diabetes)
    ...
    solucion_numerica: 66.67,
    tolerancia: 0.5,
    unidad: "% (Valor Predictivo Positivo)",
  ...
  { // P07 — ejercicio_matematico (muestreo estratificado, fraccion de muestreo por grado)
    enunciado: "Quieres encuestar a estudiantes de tu escuela sobre el uso de redes sociales. Tu escuela tiene 800 estudiantes distribuidos en 4 grados: 1o (250), 2o (210), 3o (190) y 4o (150). Decides usar muestreo estratificado con una muestra de n = 80 estudiantes. Calcula cuantos estudiantes debes encuestar de cada grado.",
    ...
    solucion_numerica: 80,
    tolerancia: 0,
    unidad: "estudiantes totales en la muestra (suma de los cuatro estratos)",
