...
type Modo = "definiciones" | "versos" | "tipos";
...
export function LabFigurasRetoricas({ color }: PracticaLabProps) {
  ...
  const estrellas = (definicionesDone ? 1 : 0) + (versosDone ? 1 : 0) + (tiposDone ? 1 : 0);
  ...
  const resetActual = modo === "definiciones" ? resetDefiniciones : modo === "versos" ? resetVersos : resetTipos;
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
              ...
              <div style={{ textAlign: "right", maxWidth: 180 }}>
                <div style={{ fontSize: 11.5, color: T.text3, lineHeight: 1.45 }}>
                  {bestEstrellas >= 3 ? "¡Lees poesía como un crítico literario!" : "Completa los tres modos para ganar las estrellas."}
                </div>
              </div>
            </div>
          </div>
