  ...
  return (
    <div style={{ color: T.text }}>
      <style>{`
        ...
        .bt-teoria-fab { position:absolute; bottom:54px; left:50%; transform:translateX(-50%); cursor:pointer; display:inline-flex; align-items:center; gap:9px;
        ...
        .bt-teoria-fab:hover { background:rgba(${color.rgba},0.28); transform:translateX(-50%) translateY(-1px); }
      `}</style>
