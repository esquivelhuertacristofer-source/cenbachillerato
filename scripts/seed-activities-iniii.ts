...
const contenidosA1 = [
  ...
  { // P02 — video_con_preguntas: Presente perfecto introductorio
    ...
    titulo_video: "Have You Ever…? Present Perfect for Experiences",
    duracion_segundos: 380,
    preguntas: [
      { tiempo_segundos: 70, pregunta: "What is the difference between 'I ate pizza' and 'I have eaten pizza'? Explain in your own words.", respuesta_guia: "'I ate pizza' refers to a specific moment in the past. 'I have eaten pizza' refers to a life experience at some unspecified time." },
      { tiempo_segundos: 200, pregunta: "What are the auxiliary verbs used in present perfect? Give one example sentence.", respuesta_guia: "Have (for I/you/we/they) and has (for he/she/it). Example: She has visited Oaxaca. I have read that book." },
      { tiempo_segundos: 330, pregunta: "Have you ever eaten something from another country? Write one sentence using present perfect.", respuesta_guia: "Example: 'I have eaten sushi' or 'I have never tried Thai food.'" },
    ],
  },
  ...
  { // P06 — video_con_preguntas: Instrucciones / Imperativos
    url_video: "https://example.com/video-pendiente-cen",
    titulo_video: "How to Give Instructions in English: Imperatives and Connectors",
    duracion_segundos: 360,
    preguntas: [
      { tiempo_segundos: 75, pregunta: "What is the imperative form? How is it formed in English? Give two examples from the video.", respuesta_guia: "The imperative uses the base verb without a subject. Examples: Open your book. Don't talk during the exam." },
      { tiempo_segundos: 210, pregunta: "What are the sequential connectors (conectores secuenciales) mentioned in the video? List at least four.", respuesta_guia: "First, then, after that, next, finally. These connectors organize a sequence of steps." },
      { tiempo_segundos: 310, pregunta: "Think of something you know how to make (a recipe, a craft, a game). Write the first three steps using imperatives and connectors.", respuesta_guia: "Example: 'First, wash your hands. Then, chop the vegetables. After that, heat the pan.' (Student's own answer will vary.)" },
    ],
  },
  ...
  { // P08 — infografia: Consolidación A2
    ...
    descripcion_accesible: "Infografía de consolidación del nivel A2: resumen visual de las estructuras gramaticales clave de Inglés III, con ejemplos bilingües y conectores para usar en producción oral y escrita.",
...
const contenidosA2 = [
  { // P01 — fill_blanks: Past Simple (verbos regulares e irregulares)
    ...
    huecos: [
      { posicion: 0, respuesta_correcta: "went", alternativas_aceptadas: [], pista: "Irregular: go → ?" },
      { posicion: 1, respuesta_correcta: "woke up", alternativas_aceptadas: ["woke"], pista: "Irregular: wake up → ?" },
      { posicion: 2, respuesta_correcta: "ate", alternativas_aceptadas: [], pista: "Irregular: eat → ?" },
      { posicion: 3, respuesta_correcta: "made", alternativas_aceptadas: [], pista: "Irregular: make → ?" },
      { posicion: 4, respuesta_correcta: "travelled", alternativas_aceptadas: ["traveled"], pista: "Regular: travel + ed" },
      { posicion: 5, respuesta_correcta: "played", alternativas_aceptadas: [], pista: "Regular: play + ed" },
      { posicion: 6, respuesta_correcta: "talked", alternativas_aceptadas: ["chatted"], pista: "Regular: talk + ed" },
      { posicion: 7, respuesta_correcta: "rested", alternativas_aceptadas: [], pista: "Regular: rest + ed" },
      { posicion: 8, respuesta_correcta: "bought", alternativas_aceptadas: [], pista: "Irregular: buy → ?" },
      { posicion: 9, respuesta_correcta: "was", alternativas_aceptadas: [], pista: "Irregular: be → was/were" },
    ],
  },
  { // P02 — fill_blanks: Presente perfecto introductorio
    ...
    huecos: [
      { posicion: 0, respuesta_correcta: "has", alternativas_aceptadas: [], pista: "Use 'has' for she/he/it" },
      { posicion: 1, respuesta_correcta: "visited", alternativas_aceptadas: [], pista: "Past participle of 'visit'" },
      { posicion: 2, respuesta_correcta: "has travelled", alternativas_aceptadas: ["has traveled"], pista: "has + past participle of travel" },
      { posicion: 3, respuesta_correcta: "has lived", alternativas_aceptadas: [], pista: "has + past participle of live" },
      { posicion: 4, respuesta_correcta: "haven't seen", alternativas_aceptadas: ["have not seen"], pista: "Negative: haven't + past participle of see" },
      { posicion: 5, respuesta_correcta: "has read", alternativas_aceptadas: [], pista: "has + past participle of read (irregular: read→read)" },
      { posicion: 6, respuesta_correcta: "has studied", alternativas_aceptadas: [], pista: "has + past participle of study" },
      { posicion: 7, respuesta_correcta: "has made", alternativas_aceptadas: [], pista: "has + past participle of make (irregular)" },
    ],
  },
  { // P03 — fill_blanks: Preposiciones de lugar
    ...
    huecos: [
      { posicion: 0, respuesta_correcta: "There is", alternativas_aceptadas: ["There's"], pista: "Singular existence" },
      { posicion: 1, respuesta_correcta: "in front of", alternativas_aceptadas: [], pista: "Facing something, on the opposite side" },
      { posicion: 2, respuesta_correcta: "Between", alternativas_aceptadas: [], pista: "In the space separating two things" },
      { posicion: 3, respuesta_correcta: "there is", alternativas_aceptadas: ["there's"], pista: "Singular — one garden" },
      { posicion: 4, respuesta_correcta: "behind", alternativas_aceptadas: [], pista: "At the back of something" },
      { posicion: 5, respuesta_correcta: "can", alternativas_aceptadas: [], pista: "Possibility: you ___ find..." },
      { posicion: 6, respuesta_correcta: "There are", alternativas_aceptadas: [], pista: "Plural existence — many stalls" },
      { posicion: 7, respuesta_correcta: "on the corner of", alternativas_aceptadas: ["at the corner of"], pista: "At the intersection of two streets" },
      { posicion: 8, respuesta_correcta: "next to", alternativas_aceptadas: ["beside"], pista: "Immediately beside something" },
    ],
  },
  { // P04 — fill_blanks: Comparativos, superlativos y hábitos
    ...
    huecos: [
      { posicion: 0, respuesta_correcta: "likes cooking", alternativas_aceptadas: ["like cooking"], pista: "like + verb-ing (she → likes)" },
      { posicion: 1, respuesta_correcta: "always", alternativas_aceptadas: [], pista: "100% of the time" },
      { posicion: 2, respuesta_correcta: "the healthiest", alternativas_aceptadas: [], pista: "Superlative of healthy" },
      { posicion: 3, respuesta_correcta: "more interesting", alternativas_aceptadas: [], pista: "Comparative of interesting (2 syllables+)" },
      { posicion: 4, respuesta_correcta: "usually", alternativas_aceptadas: ["normally"], pista: "About 80% of the time" },
      { posicion: 5, respuesta_correcta: "like running", alternativas_aceptadas: ["likes running"], pista: "like + verb-ing" },
      { posicion: 6, respuesta_correcta: "better", alternativas_aceptadas: [], pista: "Irregular comparative of good" },
    ],
  },
  { // P05 — quiz_verdadero_falso: Obligación y prohibición
    preguntas: [
      { enunciado: "'Must' and 'have to' always mean exactly the same thing and can be interchanged in every context.", respuesta: false, retroalimentacion: "False. 'Must' often expresses a personal or internal obligation, while 'have to' refers to external rules or necessities. The meaning can overlap but is not always identical." },
      { enunciado: "'You mustn't speak during the exam' means it is forbidden to speak during the exam.", respuesta: true, retroalimentacion: "True! 'Mustn't' expresses prohibition — the action is not allowed." },
      { enunciado: "'You don't have to wear a uniform on Saturdays' means it is forbidden to wear a uniform on Saturdays.", respuesta: false, retroalimentacion: "False. 'Don't have to' means it is not necessary — optional. You CAN wear a uniform if you want to; it is just not required." },
      { enunciado: "'She has to finish the report by Monday' tells us there is an external deadline.", respuesta: true, retroalimentacion: "True! 'Has to' (third person singular of have to) indicates an external obligation or necessity, like a deadline." },
      { enunciado: "The negative of 'must' for prohibition is 'mustn't', which means 'it is not allowed'.", respuesta: true, retroalimentacion: "True! 'Mustn't' = must not = not permitted/forbidden." },
      { enunciado: "'I must exercise more' is a rule imposed by someone else, like a teacher or doctor.", respuesta: false, retroalimentacion: "False. When 'must' expresses personal obligation, it reflects the speaker's own sense of necessity or moral duty — not necessarily imposed by another person." },
      { enunciado: "'Do you have to work on Sundays?' is the correct question form of 'have to'.", respuesta: true, retroalimentacion: "True! Questions with 'have to' use: Do/Does + subject + have to + base verb." },
    ],
  },
  { // P06 — fill_blanks: Instrucciones / Imperativos y conectores secuenciales
    ...
    huecos: [
      { posicion: 0, respuesta_correcta: "First", alternativas_aceptadas: ["First of all"], pista: "Connector: beginning of a sequence" },
      { posicion: 1, respuesta_correcta: "heat", alternativas_aceptadas: [], pista: "Imperative: heat the pot" },
      { posicion: 2, respuesta_correcta: "Then", alternativas_aceptadas: ["Next"], pista: "Connector: next step" },
      { posicion: 3, respuesta_correcta: "add", alternativas_aceptadas: [], pista: "Imperative: add salt and pasta" },
      { posicion: 4, respuesta_correcta: "Boil", alternativas_aceptadas: ["Cook"], pista: "Imperative: boil/cook for 10 minutes" },
      { posicion: 5, respuesta_correcta: "After that", alternativas_aceptadas: ["Then", "Next"], pista: "Connector: next action after boiling" },
      { posicion: 6, respuesta_correcta: "remove", alternativas_aceptadas: ["take"], pista: "Imperative: remove/take from stove" },
      { posicion: 7, respuesta_correcta: "Next", alternativas_aceptadas: ["Then", "After that"], pista: "Connector: following step" },
      { posicion: 8, respuesta_correcta: "add", alternativas_aceptadas: ["pour"], pista: "Imperative: add the sauce" },
      { posicion: 9, respuesta_correcta: "Finally", alternativas_aceptadas: ["Lastly"], pista: "Connector: last step" },
      { posicion: 10, respuesta_correcta: "serve", alternativas_aceptadas: [], pista: "Imperative: serve it" },
    ],
  },
  { // P07 — fill_blanks: Narración en pasado — conectores y verbos irregulares
    instrucciones: "Complete the story. For verb blanks: write the correct past simple form of the verb given in parentheses. For connector blanks: choose the best narrative connector (First / Then / Later / Suddenly / In the end).",
    texto_con_huecos: "Last Friday, Carlos ___ (wake up) very early. ___, he ___ (make) breakfast for his whole family. ___, he ___ (go) to the bus station and ___ (buy) a ticket to Puebla. The journey ___ (take) three hours. ___, he ___ (find) his old friend Miguel near the cathedral. ___, it ___ (start) to rain heavily, so they ___ (go) into a café. They ___ (talk) and ___ (eat) for two hours. ___, they ___ (say) goodbye and Carlos ___ (take) the last bus home.",
    huecos: [
      { posicion: 0, respuesta_correcta: "woke up", alternativas_aceptadas: ["woke"], pista: "Irregular: wake up → ?" },
      { posicion: 1, respuesta_correcta: "First", alternativas_aceptadas: [], pista: "Connector: beginning of the story" },
      { posicion: 2, respuesta_correcta: "made", alternativas_aceptadas: [], pista: "Irregular: make → ?" },
      { posicion: 3, respuesta_correcta: "Then", alternativas_aceptadas: ["After that"], pista: "Connector: next event" },
      { posicion: 4, respuesta_correcta: "went", alternativas_aceptadas: [], pista: "Irregular: go → ?" },
      { posicion: 5, respuesta_correcta: "bought", alternativas_aceptadas: [], pista: "Irregular: buy → ?" },
      { posicion: 6, respuesta_correcta: "took", alternativas_aceptadas: [], pista: "Irregular: take → ?" },
      { posicion: 7, respuesta_correcta: "Later", alternativas_aceptadas: [], pista: "Connector: after some time had passed" },
      { posicion: 8, respuesta_correcta: "found", alternativas_aceptadas: [], pista: "Irregular: find → ?" },
      { posicion: 9, respuesta_correcta: "Suddenly", alternativas_aceptadas: [], pista: "Connector: unexpected event" },
      { posicion: 10, respuesta_correcta: "started", alternativas_aceptadas: [], pista: "Regular: start + ed" },
      { posicion: 11, respuesta_correcta: "went", alternativas_aceptadas: [], pista: "Irregular: go → ?" },
      { posicion: 12, respuesta_correcta: "talked", alternativas_aceptadas: ["chatted"], pista: "Regular: talk + ed" },
      { posicion: 13, respuesta_correcta: "ate", alternativas_aceptadas: [], pista: "Irregular: eat → ?" },
      { posicion: 14, respuesta_correcta: "In the end", alternativas_aceptadas: ["Finally"], pista: "Connector: conclusion of the story" },
      { posicion: 15, respuesta_correcta: "said", alternativas_aceptadas: [], pista: "Irregular: say → ?" },
      { posicion: 16, respuesta_correcta: "took", alternativas_aceptadas: [], pista: "Irregular: take → ?" },
    ],
  },
  { // P08 — quiz_multiple_opcion: Repaso integral A2
    preguntas: [
      { enunciado: "Choose the correct sentence in Past Simple:", opciones: ["She goed to the market yesterday.", "She went to the market yesterday.", "She go to the market yesterday.", "She has go to the market yesterday."], respuesta_correcta: 1, retroalimentacion: "'Go' is irregular. Its past simple form is 'went'. We don't add -ed or -d to 'go'." },
      { enunciado: "'I ___ never ___ sushi before' — choose the correct present perfect form:", opciones: ["did / eat", "have / eaten", "has / eat", "was / eating"], respuesta_correcta: 1, retroalimentacion: "Present perfect: have/has + past participle. 'I have never eaten' — personal experience." },
      { enunciado: "Which sentence expresses PROHIBITION correctly?", opciones: ["You don't have to park here.", "You mustn't park here.", "You haven't parked here.", "You didn't park here."], respuesta_correcta: 1, retroalimentacion: "'Mustn't' expresses prohibition — it is not allowed. 'Don't have to' means it is not necessary, not that it is forbidden." },
      { enunciado: "'The library is ___ the school and the post office' — which preposition is correct?", opciones: ["behind", "in front of", "between", "next to"], respuesta_correcta: 2, retroalimentacion: "'Between' indicates a position in the middle of exactly two reference points (the school and the post office)." },
      { enunciado: "Choose the sentence with the correct use of a sequential connector for instructions:", opciones: ["Suddenly, add the salt and stir.", "First, wash the vegetables. Then, chop them.", "In the end, open the oven.", "Later, turn on the stove first."], respuesta_correcta: 1, retroalimentacion: "'First... Then...' correctly sequences two steps. 'Suddenly' is for unexpected events, not instructions." },
      { enunciado: "Which sentence uses the superlative correctly?", opciones: ["She is the most tallest student.", "He is the goodest player.", "This is the most beautiful city I have visited.", "They are the most fast runners."], respuesta_correcta: 2, retroalimentacion: "'Beautiful' (3 syllables) uses 'the most beautiful'. 'Most tallest', 'goodest', and 'most fast' are all incorrect forms." },
      { enunciado: "'She ___ three countries so far' — choose the correct form:", opciones: ["visited", "visits", "has visited", "was visiting"], respuesta_correcta: 2, retroalimentacion: "'So far' signals present perfect. She has visited three countries so far." },
    ],
  },
];
...
const contenidosA3 = [
  { // P01 — quiz_multiple_opcion: Past Simple
    preguntas: [
      { enunciado: "What is the past simple of 'eat'?", opciones: ["eated", "ate", "eaten", "eats"], respuesta_correcta: 1, retroalimentacion: "'Eat' is irregular. Its past simple is 'ate'. 'Eaten' is the past participle, used in present perfect." },
      { enunciado: "Choose the correct negative sentence in past simple:", opciones: ["She didn't went to school.", "She didn't go to school.", "She not went to school.", "She wasn't go to school."], respuesta_correcta: 1, retroalimentacion: "Past simple negative: subject + didn't + BASE verb. 'Go' stays as 'go', not 'went'." },
      { enunciado: "Which time expression is MOST typical with past simple?", opciones: ["already", "yet", "last week", "recently"], respuesta_correcta: 2, retroalimentacion: "'Last week' is a specific past time marker, typical of past simple. 'Already', 'yet', and 'recently' are more commonly used with present perfect." },
      { enunciado: "What is the past simple of 'buy'?", opciones: ["buyed", "buied", "bought", "buought"], respuesta_correcta: 2, retroalimentacion: "'Buy' is irregular. The past simple is 'bought'. There is no version with -ed or -ied." },
      { enunciado: "Choose the correct question in past simple:", opciones: ["Did she went to the party?", "Did she go to the party?", "Was she go to the party?", "Has she went to the party?"], respuesta_correcta: 1, retroalimentacion: "Past simple question: Did + subject + BASE verb? 'Go' does not change to 'went' after 'did'." },
      { enunciado: "'They ___ a great time at the festival last summer.'", opciones: ["have", "had", "have had", "were having"], respuesta_correcta: 1, retroalimentacion: "'Had' is the past simple of 'have'. 'Last summer' indicates a specific past time, so we use past simple." },
    ],
  },
  ...
  { // P03 — quiz_verdadero_falso: Preposiciones de lugar y there is/are
    preguntas: [
      { enunciado: "'Between' is used to describe the position of something surrounded by more than two objects.", respuesta: false, retroalimentacion: "False. 'Between' is used with exactly two reference points. For more than two, we use 'among'. Example: The statue is between the fountain and the gate." },
      { enunciado: "'There are a pharmacy on the corner' is a grammatically correct sentence.", respuesta: false, retroalimentacion: "False. 'Pharmacy' is singular, so the correct form is 'There IS a pharmacy on the corner.' 'There are' is used with plural nouns." },
      { enunciado: "'Next to' means immediately beside something, at the same level.", respuesta: true, retroalimentacion: "True! 'Next to' means al lado de — right beside something. Example: The bookstore is next to the café." },
      { enunciado: "'In front of the school there is a large garden' — this sentence is grammatically correct.", respuesta: true, retroalimentacion: "True! The preposition 'in front of' is used correctly, and 'there is' matches the singular noun 'garden'." },
      { enunciado: "'Behind' and 'in front of' describe the same position in relation to a reference point.", respuesta: false, retroalimentacion: "False. 'Behind' means detrás de (at the back), while 'in front of' means enfrente de (facing). They are opposites." },
      { enunciado: "'Can' can be used to describe what is possible to find or do in a specific place.", respuesta: true, retroalimentacion: "True! 'Can' expresses possibility. Example: 'You can find fresh fish at the coastal market.'" },
      { enunciado: "'There is many students in the classroom' is correct English.", respuesta: false, retroalimentacion: "False. 'Students' is plural, so we use 'there ARE'. Correct: 'There are many students in the classroom.'" },
    ],
  },
  { // P04 — quiz_multiple_opcion: Comparativos, superlativos y hábitos
    preguntas: [
      { enunciado: "Choose the correct comparative form:", opciones: ["She is more tall than her sister.", "She is taller than her sister.", "She is tallest than her sister.", "She is the most tall than her sister."], respuesta_correcta: 1, retroalimentacion: "'Tall' is a one-syllable adjective, so we add -er: 'taller than'. 'More tall' is incorrect for single-syllable adjectives." },
      { enunciado: "Which sentence uses 'like + verb-ing' correctly?", opciones: ["He likes to swimming in the morning.", "He like swimming in the morning.", "He likes swimming in the morning.", "He likes swim in the morning."], respuesta_correcta: 2, retroalimentacion: "'Like' (with third person -s) + verb-ing: 'He likes swimming'. Not 'to swimming' or 'swim' after like." },
      { enunciado: "Where does the frequency adverb go in: 'She ___ is ___ late for class'?", opciones: ["always / ---", "--- / always", "never / never", "--- / never"], respuesta_correcta: 1, retroalimentacion: "Frequency adverbs go AFTER the verb 'be'. Correct: 'She is always late for class.'" },
      { enunciado: "Choose the correct superlative:", opciones: ["This is the most good pizza I've eaten.", "This is the better pizza I've eaten.", "This is the best pizza I've eaten.", "This is the goodest pizza I've eaten."], respuesta_correcta: 2, retroalimentacion: "'Good' is irregular. Comparative: better. Superlative: the best." },
      { enunciado: "Complete: 'Cycling is ___ walking for long distances.'", opciones: ["more fast than", "faster than", "fastest than", "the fastest"], respuesta_correcta: 1, retroalimentacion: "'Fast' is one syllable: faster than. 'More fast' is incorrect for one-syllable adjectives." },
    ],
  },
    ...
    criterios: [
      {
        ...
        escala: [
          { valor: 1, etiqueta: "No entiendo la diferencia entre must y have to" },
          { valor: 2, etiqueta: "Entiendo el concepto pero cometo errores al usarlo" },
          { valor: 3, etiqueta: "Uso must y mustn't correctamente en la mayoría de los casos" },
          { valor: 4, etiqueta: "Uso must y mustn't con fluidez y puedo explicar la diferencia a alguien más" },
        ],
      },
      {
        descripcion: "Puedo distinguir entre una obligación externa (have to) y la ausencia de obligación (don't have to).",
        escala: [
          { valor: 1, etiqueta: "Confundo don't have to con mustn't" },
          { valor: 2, etiqueta: "Entiendo la diferencia pero me cuesta aplicarla" },
          { valor: 3, etiqueta: "Distingo correctamente entre don't have to y mustn't en la mayoría de los casos" },
          { valor: 4, etiqueta: "Aplico ambas estructuras correctamente y con confianza en situaciones reales" },
        ],
      },
      {
        ...
        escala: [
          { valor: 1, etiqueta: "Me cuesta identificar el tipo de regla en un texto" },
          { valor: 2, etiqueta: "Identifico el tipo de regla en oraciones simples" },
          { valor: 3, etiqueta: "Identifico y produzco reglas correctamente en diferentes contextos" },
          { valor: 4, etiqueta: "Analizo reglas complejas y puedo comparar sistemas de reglas en distintos contextos" },
        ],
      },
      {
        ...
        escala: [
          { valor: 1, etiqueta: "Cometo muchos errores al escribir con modales" },
          { valor: 2, etiqueta: "Escribo oraciones básicas con algunos errores" },
          { valor: 3, etiqueta: "Escribo la mayoría de las oraciones correctamente" },
          { valor: 4, etiqueta: "Escribo oraciones variadas y complejas con modales sin errores" },
        ],
      },
    ],
    reflexion_final_prompt: "Think of THREE rules from your home or school. Write them in English using must, mustn't, have to, or don't have to.",
  },
  { // P06 — quiz_multiple_opcion: Imperativos y conectores secuenciales
    preguntas: [
      { enunciado: "Which is a correct imperative sentence?", opciones: ["You open the window, please.", "Open the window, please.", "Opening the window, please.", "You must open the window, please."], respuesta_correcta: 1, retroalimentacion: "Imperatives use the base verb without a subject: 'Open the window.' Adding 'please' makes it more polite." },
      { enunciado: "Which connector introduces the LAST step in a sequence?", opciones: ["First", "Then", "After that", "Finally"], respuesta_correcta: 3, retroalimentacion: "'Finally' (or 'In the end') signals the last step in a sequence of instructions or events." },
      { enunciado: "Choose the correct negative imperative:", opciones: ["Don't to touch the screen.", "Not touch the screen.", "Don't touch the screen.", "You not touch the screen."], respuesta_correcta: 2, retroalimentacion: "Negative imperatives: Don't + base verb. 'Don't touch the screen' = está prohibido tocar la pantalla." },
      { enunciado: "Which sentence uses a connector INCORRECTLY for instructions?", opciones: ["First, wash your hands.", "Then, add the ingredients.", "Suddenly, stir the mixture for two minutes.", "Finally, let it cool before serving."], respuesta_correcta: 2, retroalimentacion: "'Suddenly' is used for unexpected events in stories, not for planned steps in instructions. Use 'After that' or 'Next' instead." },
      { enunciado: "'___ that, let the dough rest for 30 minutes.' Which connector fits best?", opciones: ["First", "Suddenly", "After", "In the end"], respuesta_correcta: 2, retroalimentacion: "'After that' (often shortened to 'after') connects sequential steps in instructions." },
    ],
  },
    ...
    criterios: [
      {
        ...
        escala: [
          { valor: 1, etiqueta: "Solo conozco 1-3 verbos irregulares y cometo errores frecuentes" },
          { valor: 2, etiqueta: "Conozco varios verbos irregulares y formo oraciones básicas" },
          { valor: 3, etiqueta: "Uso el pasado simple correctamente en afirmativas, negativas y preguntas" },
          { valor: 4, etiqueta: "Narro eventos pasados con fluidez, vocabulario variado y pocos errores" },
        ],
      },
      {
        ...
        escala: [
          { valor: 1, etiqueta: "Confundo present perfect con past simple constantemente" },
          { valor: 2, etiqueta: "Entiendo el concepto pero cometo errores al elegir entre los dos tiempos" },
          { valor: 3, etiqueta: "Uso el presente perfecto correctamente para experiencias y lo contrasto con pasado simple" },
          { valor: 4, etiqueta: "Uso present perfect con confianza incluyendo ever, never, already y yet" },
        ],
      },
      {
        descripcion: "Puedo expresar obligación, prohibición y ausencia de obligación usando must, mustn't, have to y don't have to.",
        escala: [
          { valor: 1, etiqueta: "Confundo mustn't con don't have to y no uso must con confianza" },
          { valor: 2, etiqueta: "Uso los modales en oraciones simples con algunos errores" },
          { valor: 3, etiqueta: "Distingo y uso correctamente must, mustn't, have to y don't have to" },
          { valor: 4, etiqueta: "Uso los cuatro modales con fluidez en contextos variados (escuela, hogar, sociedad)" },
        ],
      },
      {
        ...
        escala: [
          { valor: 1, etiqueta: "Solo conozco 1-2 preposiciones de lugar y me confundo fácilmente" },
          { valor: 2, etiqueta: "Uso las preposiciones principales con ayuda o con errores ocasionales" },
          { valor: 3, etiqueta: "Describo ubicaciones con las preposiciones estudiadas correctamente" },
          { valor: 4, etiqueta: "Describo lugares complejos con preposiciones variadas y there is/are sin errores" },
        ],
      },
      {
        ...
        escala: [
          { valor: 1, etiqueta: "Me cuesta escribir más de 2-3 oraciones en inglés sin errores graves" },
          { valor: 2, etiqueta: "Escribo textos cortos con errores frecuentes pero comprensibles" },
          { valor: 3, etiqueta: "Escribo textos organizados con pocos errores y vocabulario A2" },
          { valor: 4, etiqueta: "Escribo textos variados, bien conectados y con vocabulario y gramática A2 sólidos" },
        ],
      },
    ],
    reflexion_final_prompt: "What aspect of English A2 do you feel most confident about? What do you still need to practice? Write 3 sentences in English.",
  },
];
