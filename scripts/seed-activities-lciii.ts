...
const contenidosA1 = [
  ...
  { // P02 — infografia
    ...
    descripcion_accesible: "Panorama de los principales movimientos literarios desde el siglo XVII hasta el siglo XX, con sus rasgos definitorios, contexto histórico y autores representativos de habla hispana.",
  ...
  { // P05 — video_con_preguntas
    ...
    titulo_video: "El género lírico: figuras retóricas y musicalidad del verso",
    duracion_segundos: 510,
    preguntas: [
      { tiempo_segundos: 80, pregunta: "¿Cuál es la diferencia entre metáfora e hipérbole como figuras retóricas?", respuesta_guia: "La metáfora establece una identidad entre dos realidades distintas; la hipérbole exagera una cualidad para producir efecto expresivo." },
      { tiempo_segundos: 210, pregunta: "¿Qué es el hipérbaton y qué efecto produce en el verso?", respuesta_guia: "Es la alteración del orden sintáctico habitual; produce extrañamiento, ritmo especial y énfasis en ciertas palabras." },
      { tiempo_segundos: 370, pregunta: "¿En qué se diferencia la rima consonante de la rima asonante?", respuesta_guia: "La consonante repite todos los sonidos (vocales y consonantes) desde la última vocal tónica; la asonante solo repite las vocales." },
    ],
  },
  { // P06 — lectura
  ...
  { // P07 — video_con_preguntas
    url_video: "https://example.com/video-pendiente-cen",
    titulo_video: "La exposición oral formal: coloquio, simposio y foro",
    duracion_segundos: 480,
    preguntas: [
      { tiempo_segundos: 90, pregunta: "¿En qué se diferencia un coloquio de un simposio y de un foro?", respuesta_guia: "El coloquio es una conversación entre expertos; el simposio presenta ponencias especializadas sucesivas; el foro abre la participación al público." },
      { tiempo_segundos: 250, pregunta: "¿Qué elementos logísticos deben planearse antes de una exposición oral formal?", respuesta_guia: "Tiempo asignado, materiales de apoyo, distribución del espacio, turnos de participación y protocolo de preguntas." },
      { tiempo_segundos: 410, pregunta: "¿Cuál es la diferencia entre un argumento y una opinión en la exposición oral?", respuesta_guia: "El argumento se sostiene con evidencias, datos o razonamiento lógico; la opinión es una afirmación personal sin respaldo." },
    ],
  },
];
...
const contenidosA2 = [
  { // P01 — quiz_multiple_opcion
    preguntas: [
      { enunciado: "¿Cuál es el propósito principal de la paráfrasis en la lectura crítica?", opciones: ["Copiar el texto con otras palabras para recordarlo", "Verificar la comprensión real del texto reformulándolo sin agregar ni quitar información", "Resumir el texto eliminando los detalles", "Traducir el texto a un lenguaje más sencillo"], respuesta_correcta: 1, retroalimentacion: "La paráfrasis es una prueba de comprensión: si no podemos reformular el texto fielmente, no lo hemos entendido." },
      { enunciado: "Identificar la postura del autor implica:", opciones: ["Buscar errores ortográficos o gramaticales", "Reconocer su punto de vista, valores y qué perspectivas omite deliberadamente", "Contar cuántas veces repite una idea", "Traducir sus metáforas a lenguaje literal"], respuesta_correcta: 1, retroalimentacion: "La postura del autor incluye sus supuestos ideológicos y las voces que excluye, no solo lo que dice explícitamente." },
      { enunciado: "¿Qué distingue a un lector crítico de uno literal?", opciones: ["El lector crítico solo lee textos académicos", "El lector crítico cuestiona, interpreta y evalúa; el literal solo extrae lo que el texto dice explícitamente", "El lector crítico desconfía de todo lo escrito", "No hay diferencia real entre ambos tipos de lectura"], respuesta_correcta: 1, retroalimentacion: "La lectura crítica añade interpretación y evaluación a la comprensión literal: va más allá de lo explícito." },
      { enunciado: "El 'sentido global del texto' se refiere a:", opciones: ["La extensión total del texto", "El propósito comunicativo, el lector al que va dirigido y el efecto que busca producir", "El número de ideas que contiene", "El vocabulario más difícil del texto"], respuesta_correcta: 1, retroalimentacion: "El sentido global integra propósito, destinatario y efecto buscado: es la intención comunicativa completa." },
      { enunciado: "¿Por qué no todo texto es neutral según la lectura crítica?", opciones: ["Porque todos los textos tienen errores", "Porque el autor selecciona, enfatiza y omite desde una posición determinada", "Porque el lenguaje es siempre subjetivo", "Porque los textos son escritos por personas con emociones"], respuesta_correcta: 1, retroalimentacion: "La selección, el énfasis y la omisión son actos del autor que revelan su postura frente al tema." },
    ],
    intentos_maximos: 3,
  ...
  { // P02 — quiz_multiple_opcion
    preguntas: [
      { enunciado: "¿Qué caracteriza principalmente al Barroco literario?", opciones: ["Lenguaje simple y directo con propósito moral", "Lenguaje ornamental, contrastes extremos y el tema del desengaño del mundo", "Representación objetiva de la sociedad contemporánea", "Ruptura radical con todas las convenciones literarias anteriores"], respuesta_correcta: 1, retroalimentacion: "El Barroco se distingue por su lenguaje recargado y el contraste entre apariencia y realidad, reflejando el desengaño de su época." },
      { enunciado: "El Romanticismo literario se caracteriza por:", opciones: ["Valorar la razón por encima de la emoción", "El individualismo, la emoción, la naturaleza sublime y la rebeldía frente al orden establecido", "Representar la vida cotidiana de la clase trabajadora", "Experimentar con la forma y rechazar la sintaxis convencional"], respuesta_correcta: 1, retroalimentacion: "El Romanticismo reacciona contra el racionalismo ilustrado exaltando el yo, la emoción y la naturaleza." },
      { enunciado: "¿Qué distingue al Realismo literario del Romanticismo?", opciones: ["El Realismo usa más metáforas y recursos poéticos", "El Realismo busca representar objetivamente la sociedad, con crítica social y personajes ordinarios", "El Realismo se centra en mundos imaginarios", "No hay diferencias significativas entre ambos movimientos"], respuesta_correcta: 1, retroalimentacion: "El Realismo reacciona contra el idealismo romántico: prefiere lo cotidiano, lo social y lo verosímil." },
      { enunciado: "¿Cuál es el rasgo más representativo del Modernismo hispanoamericano?", opciones: ["La representación cruda de la marginalidad urbana", "La musicalidad, el lenguaje preciosista, el cosmopolitismo y la renovación formal", "La integración de lo maravilloso en lo cotidiano", "La ruptura total con el lenguaje literario tradicional"], respuesta_correcta: 1, retroalimentacion: "El Modernismo, liderado por Rubén Darío, renueva el castellano literario con musicalidad, exotismo y cuidado formal extremo." },
      { enunciado: "El Realismo mágico se caracteriza por:", opciones: ["Narrar solo hechos históricos comprobables", "Integrar elementos maravillosos o sobrenaturales en la realidad cotidiana de manera natural", "Ambientar sus historias en mundos completamente fantásticos", "Rechazar los elementos culturales latinoamericanos"], respuesta_correcta: 1, retroalimentacion: "En el Realismo mágico, lo extraordinario coexiste con lo cotidiano sin asombrar a los personajes: es parte de su mundo." },
    ],
    intentos_maximos: 3,
    puntaje_minimo_aprobacion: 70,
    mezclar_preguntas: false,
  ...
  { // P03 — quiz_verdadero_falso
    preguntas: [
      { enunciado: "La novela y el cuento pertenecen al mismo género literario: la narrativa.", respuesta: true, retroalimentacion: "Correcto. Ambos son subgéneros narrativos; se diferencian en extensión y forma de construir el efecto." },
      { enunciado: "El ensayo literario es siempre objetivo y no admite la voz personal del autor.", respuesta: false, retroalimentacion: "Falso. El ensayo acepta y valora la subjetividad: el autor reflexiona con voz propia, a diferencia del artículo científico." },
      { enunciado: "El teatro o drama está escrito para ser representado, no solo leído.", respuesta: true, retroalimentacion: "Correcto. El texto dramático presupone una puesta en escena con actores, espacio y público." },
      { enunciado: "La lírica siempre tiene rima y métrica fija: no existe la poesía en verso libre.", respuesta: false, retroalimentacion: "Falso. La poesía moderna incluye el verso libre, que prescinde de rima y métrica regular pero mantiene conciencia del ritmo y la imagen." },
      { enunciado: "Los géneros literarios pueden mezclarse: una novela puede contener poemas o ensayos dentro.", respuesta: true, retroalimentacion: "Correcto. La hibridación de géneros es frecuente en la literatura contemporánea: muchas novelas integran poesía, cartas o ensayos." },
      { enunciado: "La tragedia termina siempre con la muerte o la derrota del protagonista.", respuesta: true, retroalimentacion: "Correcto. La tragedia clásica concluye con una pérdida irreparable que genera catarsis en el espectador." },
    ],
    intentos_maximos: 2,
    puntaje_minimo_aprobacion: 70,
  },
  { // P04 — fill_blanks
    ...
    huecos: [
      { posicion: 0, respuesta_correcta: "suspenso", alternativas_aceptadas: ["thriller", "género de suspenso"], pista: "Subgénero que genera expectativa sobre el desenlace" },
      { posicion: 1, respuesta_correcta: "sobrenatural", alternativas_aceptadas: ["fantástico", "de lo sobrenatural"], pista: "Terror que usa elementos fantásticos como monstruos o fantasmas" },
      { posicion: 2, respuesta_correcta: "psicológico", alternativas_aceptadas: ["interior", "mental"], pista: "Terror que viene de la mente, no de criaturas externas" },
      { posicion: 3, respuesta_correcta: "autoficción", alternativas_aceptadas: ["auto-ficción", "ficción autobiográfica"], pista: "Subgénero que combina lo autobiográfico con lo inventado" },
      { posicion: 4, respuesta_correcta: "Antropoceno", alternativas_aceptadas: ["antropoceno", "Anthropocene"], pista: "Época geológica caracterizada por el impacto humano en el planeta" },
    ],
  },
  { // P05 — quiz_multiple_opcion
    preguntas: [
      { enunciado: "¿Cuál de los siguientes versos contiene una metáfora?", opciones: ["El sol brillaba con fuerza ayer", "Tus ojos son dos luceros que iluminan la noche", "Caminé lentamente por la orilla del río", "El viento sopló durante toda la tarde"], respuesta_correcta: 1, retroalimentacion: "«Tus ojos son dos luceros» establece una identidad entre dos realidades distintas: la metáfora identifica ojos con astros luminosos." },
      { enunciado: "La hipérbole es una figura retórica que:", opciones: ["Compara dos realidades con 'como' o 'cual'", "Atribuye cualidades humanas a objetos inanimados", "Exagera una cualidad o situación para producir efecto expresivo", "Invierte el orden normal de las palabras en la frase"], respuesta_correcta: 2, retroalimentacion: "La hipérbole amplifica: «te lo he dicho un millón de veces» es hiperbólico porque exagera con intención expresiva." },
      { enunciado: "¿Qué figura retórica hay en el verso «el mar llora su soledad de espuma»?", opciones: ["Hipérbaton", "Ironía", "Prosopopeya o personificación", "Hipérbole"], respuesta_correcta: 2, retroalimentacion: "Atribuir al mar la capacidad de llorar es una prosopopeya: se asigna una cualidad humana (llorar) a algo no humano (el mar)." },
      { enunciado: "La ironía en el lenguaje literario consiste en:", opciones: ["Exagerar una cualidad hasta el absurdo", "Decir lo contrario de lo que se quiere significar, esperando que el receptor lo comprenda", "Atribuir vida a objetos inanimados", "Invertir el orden de los elementos de la oración"], respuesta_correcta: 1, retroalimentacion: "La ironía juega con la distancia entre lo dicho y lo querido decir; requiere que el lector reconozca esa distancia." },
      { enunciado: "¿Qué diferencia a la rima consonante de la rima asonante?", opciones: ["La consonante rima solo en las vocales; la asonante repite todos los sonidos", "La consonante repite todos los sonidos desde la última vocal tónica; la asonante solo repite las vocales", "La asonante es más culta que la consonante", "No hay diferencia real entre ambas en la poesía moderna"], respuesta_correcta: 1, retroalimentacion: "«amor/calor» es asonante (solo vocales -o-); «amor/temblor» es consonante (todos los sonidos desde la o tónica)." },
    ],
    intentos_maximos: 3,
    puntaje_minimo_aprobacion: 70,
    mezclar_preguntas: false,
  ...
  { // P06 — fill_blanks
    ...
    huecos: [
      { posicion: 0, respuesta_correcta: "descripción", alternativas_aceptadas: ["síntesis", "presentación", "descripcion"], pista: "Primer componente: presentar qué hay en la obra" },
      { posicion: 1, respuesta_correcta: "juicio", alternativas_aceptadas: ["valoración", "opinión argumentada", "evaluación"], pista: "Componente que evalúa con argumentos" },
      { posicion: 2, respuesta_correcta: "introducción", alternativas_aceptadas: ["introduccion", "apertura", "inicio"], pista: "Primera sección estructural de la reseña" },
      { posicion: 3, respuesta_correcta: "desarrollo", alternativas_aceptadas: ["cuerpo", "cuerpo del texto"], pista: "Sección central donde se analiza la obra" },
      { posicion: 4, respuesta_correcta: "valoración", alternativas_aceptadas: ["evaluación", "juicio", "opinion", "opinión"], pista: "Lo que expresa el reseñador al final sobre la obra" },
    ],
  },
  { // P07 — quiz_multiple_opcion
    preguntas: [
      { enunciado: "¿Cuál es la diferencia principal entre un coloquio y un foro?", opciones: ["El coloquio es más informal que el foro", "El coloquio es una conversación entre expertos; el foro abre la participación al público general", "El foro es solo para especialistas; el coloquio es para estudiantes", "No hay diferencia: son sinónimos"], respuesta_correcta: 1, retroalimentacion: "El coloquio convoca a expertos en diálogo; el foro amplía la voz al público, que puede preguntar o participar." },
      { enunciado: "¿Qué diferencia a un argumento de una opinión en la exposición oral?", opciones: ["El argumento es más largo que la opinión", "El argumento se sostiene con evidencias, datos o razonamiento lógico; la opinión es una afirmación personal sin respaldo", "La opinión siempre es más convincente que el argumento", "No hay diferencia: toda opinión es un argumento"], respuesta_correcta: 1, retroalimentacion: "Argumentar implica fundamentar: datos, ejemplos, citas o razonamientos lógicos que sostienen la afirmación." },
      { enunciado: "En una exposición oral formal, ¿qué función tiene el tiempo asignado?", opciones: ["Es solo una referencia: el expositor puede ignorarlo", "Estructura la intervención y obliga a priorizar los puntos más importantes", "Solo importa en competencias académicas, no en foros reales", "Indica cuántas diapositivas puede usar el expositor"], respuesta_correcta: 1, retroalimentacion: "Respetar el tiempo es parte de la cortesía comunicativa y obliga a seleccionar lo más relevante para decir." },
      { enunciado: "¿Cuál es el propósito del protocolo de preguntas en un simposio?", opciones: ["Evitar que el público haga preguntas difíciles", "Organizar los turnos de participación para que el intercambio sea ordenado y respetuoso", "Limitar la exposición a solo las preguntas preaprobadas", "Sustituir la exposición oral por un turno de preguntas"], respuesta_correcta: 1, retroalimentacion: "El protocolo de preguntas regula la participación: garantiza orden, respeto y que todos puedan intervenir." },
      { enunciado: "Usar evidencias en la argumentación oral significa:", opciones: ["Hablar con mucha confianza y volumen de voz alto", "Apoyar las afirmaciones con datos, ejemplos, citas o referencias verificables", "Repetir varias veces la misma idea para que quede clara", "Hablar más tiempo que los demás participantes"], respuesta_correcta: 1, retroalimentacion: "La evidencia da credibilidad al argumento: datos estadísticos, ejemplos reales, citas de expertos o referencias comprobables." },
    ],
    intentos_maximos: 3,
    puntaje_minimo_aprobacion: 70,
    mezclar_preguntas: false,
...
const contenidosA3 = [
  ...
  { // P02 — glosario_interactivo
    terminos: [
      { termino: "Barroco", definicion: "Movimiento literario del siglo XVII caracterizado por el lenguaje ornamental, los contrastes extremos (luz/sombra, vida/muerte) y el tema del desengaño del mundo.", ejemplo: "Los sonetos de Quevedo y la poesía de Sor Juana Inés de la Cruz son ejemplos representativos del Barroco hispanoamericano.", etiquetas: ["siglo XVII", "ornamental", "desengaño", "contrastes", "Hispanoamérica"] },
      { termino: "Neoclasicismo", definicion: "Movimiento del siglo XVIII que priorizó la razón, el orden y la claridad sobre la emoción; valoró la función didáctica y moral de la literatura como vehículo ilustrado.", ejemplo: "Las fábulas de Samaniego y Tomás de Iriarte son textos neoclásicos que enseñan valores morales.", etiquetas: ["siglo XVIII", "Ilustración", "razón", "moral", "didáctico"] },
      { termino: "Romanticismo", definicion: "Movimiento del siglo XIX (primera mitad) que exaltó el individualismo, la emoción, la naturaleza sublime y la rebeldía frente al orden racional establecido por la Ilustración.", ejemplo: "Las Rimas de Bécquer y los poemas de Espronceda representan el Romanticismo español con su lenguaje apasionado.", etiquetas: ["siglo XIX", "individualismo", "emoción", "naturaleza", "rebeldía"] },
      { termino: "Realismo", definicion: "Movimiento de la segunda mitad del siglo XIX que buscó representar objetivamente la realidad social, con crítica a las instituciones y personajes ordinarios como protagonistas.", ejemplo: "Fortunata y Jacinta de Galdós retrata la sociedad española con sus contradicciones de clase y sus hipocresías.", etiquetas: ["siglo XIX", "objetividad", "crítica social", "personajes ordinarios", "verosimilitud"] },
      { termino: "Modernismo", definicion: "Movimiento hispanoamericano de fines del siglo XIX e inicios del XX que renovó el lenguaje literario con musicalidad, preciosismo, cosmopolitismo y una búsqueda de la belleza como valor supremo.", ejemplo: "Azul... de Rubén Darío inauguró el Modernismo hispanoamericano con sus versos musicales y sus referencias a la mitología griega.", etiquetas: ["fin de siglo", "musicalidad", "cosmopolitismo", "Rubén Darío", "renovación formal"] },
      { termino: "Vanguardias", definicion: "Conjunto de movimientos artísticos y literarios de 1910-1940 (creacionismo, ultraísmo, surrealismo, futurismo) que rompieron radicalmente con las convenciones formales y temáticas anteriores.", ejemplo: "Los caligramas de Apollinaire y los poemas visuales de Vicente Huidobro son ejemplos de la ruptura vanguardista.", etiquetas: ["siglo XX", "ruptura", "experimentación", "surrealismo", "ultraísmo", "creacionismo"] },
      { termino: "Realismo mágico", definicion: "Corriente narrativa latinoamericana del siglo XX que integra elementos maravillosos o sobrenaturales en la realidad cotidiana de manera natural, sin asombro por parte de los personajes.", ejemplo: "En Cien años de soledad de García Márquez, Remedios la Bella asciende al cielo mientras tiende sábanas, y los habitantes de Macondo lo aceptan con total naturalidad.", etiquetas: ["América Latina", "maravilloso", "cotidiano", "García Márquez", "Rulfo", "Carpentier"] },
      { termino: "Naturalismo", definicion: "Variante extrema del Realismo que aplicó métodos científicos (determinismo biológico y social) a la literatura, mostrando cómo el ambiente y la herencia condicionan el comportamiento humano.", ejemplo: "Las obras de Émile Zola y Emilia Pardo Bazán muestran personajes cuyas vidas están determinadas por su clase social, su biología y su entorno.", etiquetas: ["siglo XIX", "determinismo", "ciencia", "ambiente social", "herencia"] },
    ],
  },
    ...
    criterios: [
      {
        ...
        escala: [
          { valor: 1, etiqueta: "No reconozco los subgéneros aún" },
          { valor: 2, etiqueta: "Reconozco 1-2 subgéneros en textos sencillos" },
          { valor: 3, etiqueta: "Reconozco la mayoría de los subgéneros con sus rasgos principales" },
          { valor: 4, etiqueta: "Identifico el subgénero y explico qué rasgos lo confirman" },
        ],
      },
      {
        ...
        escala: [
          { valor: 1, etiqueta: "Confundo frecuentemente los subgéneros entre sí" },
          { valor: 2, etiqueta: "Distingo algunos con ayuda de ejemplos" },
          { valor: 3, etiqueta: "Distingo la mayoría con razonamientos claros" },
          { valor: 4, etiqueta: "Distingo y explico con ejemplos propios o textuales" },
        ],
      },
      {
        ...
        escala: [
          { valor: 1, etiqueta: "No entiendo para qué sirve distinguir subgéneros" },
          { valor: 2, etiqueta: "Entiendo la distinción pero no le veo utilidad práctica" },
          { valor: 3, etiqueta: "Valoro la distinción para leer mejor y con más contexto" },
          { valor: 4, etiqueta: "Valoro la diversidad y la relaciono con distintas necesidades culturales y lectoras" },
        ],
      },
      {
        ...
        escala: [
          { valor: 1, etiqueta: "No logro aplicar el conocimiento fuera del aula" },
          { valor: 2, etiqueta: "Lo intento pero me cuesta sin guía" },
          { valor: 3, etiqueta: "Lo aplico con éxito en textos sencillos o conocidos" },
          { valor: 4, etiqueta: "Lo aplico con confianza en textos nuevos y variados" },
        ],
      },
    ],
    reflexion_final_prompt: "¿Cuál subgénero narrativo te resultó más difícil de identificar? ¿Qué rasgo lo hace más complejo de reconocer? Menciona un texto (libro, serie, película) que hayas consumido recientemente y clasifícalo en un subgénero narrativo. Justifica tu elección.",
  },
    ...
    criterios: [
      {
        ...
        escala: [
          { valor: 1, etiqueta: "Dependo completamente de mis notas y no puedo responder preguntas" },
          { valor: 2, etiqueta: "Conozco el tema básicamente pero me cuesta argumentar sin apoyo" },
          { valor: 3, etiqueta: "Domino el tema y puedo desarrollar argumentos con fluidez" },
          { valor: 4, etiqueta: "Domino el tema profundamente y puedo relacionarlo con otras ideas o preguntas inesperadas" },
        ],
      },
      {
        descripcion: "Soy capaz de sostener mis afirmaciones con evidencias, datos o ejemplos durante la exposición oral",
        escala: [
          { valor: 1, etiqueta: "Hago afirmaciones sin ningún respaldo" },
          { valor: 2, etiqueta: "Intento dar ejemplos pero no siempre son pertinentes" },
          { valor: 3, etiqueta: "Argumento con ejemplos o datos relevantes en la mayoría de mis afirmaciones" },
          { valor: 4, etiqueta: "Argumento con evidencias precisas, pertinentes y variadas en toda mi exposición" },
        ],
      },
      {
        ...
        escala: [
          { valor: 1, etiqueta: "No conozco bien el formato ni el rol que me toca" },
          { valor: 2, etiqueta: "Conozco el formato pero me cuesta respetarlo en la práctica" },
          { valor: 3, etiqueta: "Respeto el formato y el tiempo asignado con algunos ajustes" },
          { valor: 4, etiqueta: "Me desenvuelvo con naturalidad en el formato, respetando protocolo y adaptándome a lo que ocurre" },
        ],
      },
      {
        ...
        escala: [
          { valor: 1, etiqueta: "Me cuesta mantener contacto visual y controlar los nervios" },
          { valor: 2, etiqueta: "Intento usar el contacto visual pero mi postura o voz no acompañan" },
          { valor: 3, etiqueta: "Comunico con claridad usando voz, mirada y postura de manera coordinada" },
          { valor: 4, etiqueta: "Mi presencia refuerza el mensaje: voz modulada, contacto visual fluido y lenguaje corporal abierto" },
        ],
      },
    ],
    reflexion_final_prompt: "¿Qué aspectos del tema de tu exposición necesitas reforzar antes de presentar? ¿Qué tipo de evidencia (datos estadísticos, citas, ejemplos literarios) es más adecuada para tu exposición? ¿Cuál aspecto del protocolo del formato te resulta más difícil de seguir? ¿Qué aspecto de tu comunicación no verbal quieres mejorar y cómo practicarás?",
  },
];
