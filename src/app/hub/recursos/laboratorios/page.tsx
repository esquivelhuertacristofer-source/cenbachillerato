...
import { TodosLosLaboratorios } from "@/components/practicas/TodosLosLaboratorios";
...
export default function LaboratoriosPage() {
  ...
  const [tab, setTab] = useState<"destacados" | "semestre" | "todos">("destacados");
  ...
  const totalTodos = Object.keys(LAB_CATALOGO).length;
    ...
    <div className="labs-page">
      ...
      <div className="labs-tabs" role="tablist" aria-label="Vistas de laboratorios">
        ...
        <button
          type="button"
          role="tab"
          aria-selected={tab === "semestre"}
          className={`labs-tab ${tab === "semestre" ? "is-active" : ""}`}
        ...
        <button
          ...
          className={`labs-tab ${tab === "todos" ? "is-active" : ""}`}
          onClick={() => setTab("todos")}
        >
          <i className="fa-solid fa-layer-group" /> Todos
          <span className="labs-tab-count">{totalTodos}</span>
        </button>
      </div>
