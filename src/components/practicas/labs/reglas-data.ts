...
export const FUNCIONES: Funcion[] = [
  {
    ...
    contexto: "El caso verbatim del A2 (a). Se deriva cada potencia por separado: cada xⁿ aporta n·xⁿ⁻¹ y la constante −1 desaparece. La derivada f'(x) = 15x⁴ − 6x² + 7 es siempre positiva (mínimo 6.55), así que la curva de la derivada nunca baja del eje: f crece en todo su dominio.",
    pasos: [
      ...
      { etiqueta: "3", texto: "f'(x) = 15x⁴ − 6x² + 7. (Es ≥ 6.55 siempre: f siempre crece.)" },
    ],
