...
export const PRACTICAS: Record<string, PracticaDef> = {
  ...
  "estados-materia": {
    ...
    descripcion:
      "Elige una sustancia y mueve la temperatura: observa cómo las partículas pasan de sólido a líquido y gas según su energía cinética (teoría cinético-molecular).",
    Component: LabEstadosMateria,
  },
  "modelos-atomicos": {
    slug: "modelos-atomicos",
    titulo: "Laboratorio 3D — Modelos atómicos",
    descripcion:
      "Recorre la evolución del átomo, de Dalton a Schrödinger: arma el núcleo con protones y neutrones reales y observa cómo cambió la idea del átomo con cada nuevo modelo.",
    Component: LabModelosAtomicos,
  },
  "enlaces-quimicos": {
    slug: "enlaces-quimicos",
    titulo: "Laboratorio 3D — Enlaces químicos",
    descripcion:
      "Construye moléculas en 3D y descubre por qué los átomos se unen: comparten electrones (covalente) o los transfieren (iónico) según la diferencia de electronegatividad.",
    Component: LabEnlacesQuimicos,
  },
  "conservacion-materia": {
    slug: "conservacion-materia",
    titulo: "Laboratorio 3D — Conservación de la materia",
    descripcion:
      "Avanza una reacción química y observa cómo los mismos átomos se reacomodan de reactivos a productos: la materia no se crea ni se destruye, solo se transforma (Ley de Lavoisier).",
    Component: LabConservacionMateria,
  },
  "energia-electricidad": {
    slug: "energia-electricidad",
    titulo: "Laboratorio 3D — Energía y electricidad",
    descripcion:
      "Arma un circuito: cierra el interruptor, sube el voltaje y prueba materiales. Observa cómo la corriente es el flujo de electrones y cómo la energía eléctrica enciende el foco (P = V · I).",
    Component: LabEnergiaElectricidad,
  },
  "separacion-mezclas": {
    slug: "separacion-mezclas",
    titulo: "Laboratorio 3D — Separación de mezclas",
    descripcion:
      "Elige una mezcla y un método de separación (filtración, decantación, destilación o imantación). Descubre que solo separa el método que aprovecha la propiedad física en que difieren sus componentes.",
    Component: LabSeparacionMezclas,
  },
  "propiedades-materia": {
    slug: "propiedades-materia",
    titulo: "Laboratorio 3D — Propiedades y cambios de la materia",
    descripcion:
      "Aplica transformaciones a una sustancia (fundir, romper, quemar, oxidar…) y clasifícalas como cambio físico o químico observando la evidencia: ¿sigue siendo la misma sustancia o se formó una nueva?",
    Component: LabPropiedadesMateria,
  },
  "fracciones-porcentajes": {
    slug: "fracciones-porcentajes",
    titulo: "Laboratorio 3D — Fracciones, decimales y porcentajes",
    descripcion:
      "Construye una fracción n/d y obsérvala como pastel y barra: lee la misma cantidad de tres formas equivalentes (fracción, decimal y porcentaje), descubre fracciones equivalentes y aplica el porcentaje a una cantidad real (descuento, propina, impuesto).",
    Component: LabFracciones,
  },
  "potencias-raices": {
    slug: "potencias-raices",
    titulo: "Laboratorio 3D — Potencias y raíces",
    descripcion:
      "Elige una base y un exponente (² o ³) y mira la potencia construida con cubitos: n² es un cuadrado (área) y n³ un cubo (volumen). Resalta el lado para descubrir la raíz como operación inversa: √(n²)=n y ∛(n³)=n.",
    Component: LabPotencias,
  },
  "concentracion-disolucion": {
    slug: "concentracion-disolucion",
    titulo: "Laboratorio 3D — Concentración de una disolución (% en masa)",
    descripcion:
      "Prepara una disolución: elige un soluto, agrega gramos de soluto y de agua y observa cómo cambia la concentración en % en masa = (masa de soluto / masa de la disolución) × 100. Diluye con más agua y satura la disolución al rebasar la solubilidad del soluto.",
    Component: LabConcentracion,
  },
  "razon-proporcion": {
    slug: "razon-proporcion",
    titulo: "Laboratorio 3D — Razón y proporción",
    descripcion:
      "Elige un escenario real y mueve el deslizador: observa en una gráfica 3D cómo responde la otra cantidad y descubre qué permanece constante. En la proporción directa la razón Y/X no cambia (recta por el origen); en la inversa el producto X·Y se conserva (hipérbola).",
    Component: LabProporcion,
  },
  "recta-numerica": {
    slug: "recta-numerica",
    titulo: "Laboratorio 3D — Recta numérica",
    descripcion:
      "Ubica enteros y racionales sobre una recta numérica 3D en un contexto real (termómetro, altitud, dinero): descubre que el signo dice de qué lado del cero está cada número y que su valor absoluto es la distancia al cero. En el modo operar, sumar es un salto a la derecha y restar un salto a la izquierda, así se ve por qué restar es sumar el opuesto.",
    Component: LabRectaNumerica,
  },
  "notacion-cientifica": {
    slug: "notacion-cientifica",
    titulo: "Laboratorio 3D — Notación científica",
    descripcion:
      "Arma un número en notación científica (mantisa × 10ⁿ) y viaja por una torre de escalas reales, del átomo al Sol: descubre que el exponente solo corre el punto decimal (positivo agranda, negativo achica) y que convertir de unidad (m ↔ km ↔ mm) únicamente cambia ese exponente. Del átomo al Sol hay 19 saltos de ×10.",
    Component: LabNotacionCientifica,
  },
  "valor-posicional": {
    slug: "valor-posicional",
    titulo: "Laboratorio 3D — Valor posicional",
    descripcion:
      "Arma un número de hasta cuatro cifras con bloques base-10 (cubito, barra, placa y cubo) y descubre por qué el lugar de una cifra decide su valor: cada posición vale 10 veces la de su derecha (unidad → decena → centena → millar). Ve la descomposición cifra × valor del lugar y el papel del cero como marcador de posición.",
    Component: LabValorPosicional,
  },
  "sistemas-ecuaciones-2x2": {
    slug: "sistemas-ecuaciones-2x2",
    titulo: "Laboratorio 3D — Sistemas de ecuaciones 2×2",
    descripcion:
      "El plano cartesiano es el piso y cada ecuación es una recta: resolver el sistema es hallar dónde se cruzan. Elige una situación real o uno de los tres casos e inclina la segunda recta para descubrir cuándo hay una solución (se cruzan y se levanta una columna), ninguna (paralelas) o infinitas (coincidentes).",
    Component: LabSistemas,
  },
  "ecuacion-lineal-balanza": {
    slug: "ecuacion-lineal-balanza",
    titulo: "Laboratorio 3D — Ecuación lineal de una variable (la balanza)",
    descripcion:
      "Una ecuación a·x + b = c es una balanza en equilibrio: los dos platos pesan lo mismo. Despeja la x aplicando la propiedad de uniformidad —quita las mismas unidades de ambos lados y reparte en partes iguales— y mira cómo la balanza permanece nivelada; si operas en un solo lado, se inclina porque rompiste la igualdad.",
    Component: LabBalanza,
  },
  "teorema-pitagoras": {
    slug: "teorema-pitagoras",
    titulo: "Laboratorio 3D — Teorema de Pitágoras",
    descripcion:
      "Sobre cada lado de un triángulo rectángulo se levanta un cuadrado: el de la hipotenusa (c²) tiene la misma área que la suma de los de los catetos (a² + b²). Mueve los catetos para descubrir por qué a² + b² = c², reconocer ternas pitagóricas (lados enteros) y calcular distancias reales —la escalera, la diagonal de una pantalla o de un terreno, el hilo de un papalote— cuando conoces dos lados.",
    Component: LabPitagoras,
  },
  "volumen-cilindro": {
    slug: "volumen-cilindro",
    titulo: "Laboratorio 3D — Volumen de un cilindro",
    descripcion:
      "Un tanque cilíndrico transparente que se llena de líquido: el volumen es el área de la base circular (π·r²) por la altura (h), es decir V = π·r²·h. Mueve el radio, la altura y el nivel de llenado para ver el volumen como discos apilados, leer la capacidad real en litros (1 m³ = 1000 L) en tanques reales —tinaco, cisterna, tambo, silo— y descubrir que, como el radio está al cuadrado, ensanchar el tanque sube el volumen mucho más rápido que hacerlo más alto.",
    Component: LabCilindro,
  },
  "factorizacion-area": {
    slug: "factorizacion-area",
    titulo: "Laboratorio 3D — Factorización: el modelo de área",
    descripcion:
      "Un trinomio x² + bx + c es el área de un rectángulo y factorizarlo es hallar sus dos lados. Con piezas de álgebra (una x², varias x y unidades) construye el rectángulo de lados (x + p)(x + q) y descubre la regla 'suma y producto': b = p + q y c = p·q. Cuando p = q el rectángulo es un cuadrado (trinomio cuadrado perfecto). Incluye un panel con las cuatro técnicas de la actividad: factor común, diferencia de cuadrados, trinomio cuadrado perfecto y trinomio x² + bx + c.",
    Component: LabFactorizacion,
  },
  "ecuacion-lineal-barras": {
    slug: "ecuacion-lineal-barras",
    titulo: "Laboratorio 3D — Ecuaciones lineales: el modelo de barras",
    descripcion:
      "Plantear un problema en palabras como una ecuación a·x + b = c y resolverlo, hecho visible con un modelo de barras (tape diagram): cada cantidad de la historia es un segmento. La incógnita aporta a·x, la parte fija es la constante b, y el total conocido es la meta c. Mueve la incógnita hasta que la barra llegue justo a la meta y descubre el despeje x = (c − b) / a. Tres problemas verbatim de la actividad: el doble de un número aumentado en 7, el artesano que cobra por hora más materiales fijos, y dos hermanos cuyas edades suman 45. Complementa el laboratorio de la balanza, que enfatiza el equilibrio al despejar.",
    Component: LabEcuaciones,
  },
  "productos-notables-3d": {
    slug: "productos-notables-3d",
    titulo: "Laboratorio 3D — Productos notables: área y volumen",
    descripcion:
      "Un producto notable no se memoriza, se ve como una figura que se descompone. El binomio al cuadrado (a + b)² es el área de un cuadrado partido en a² + 2ab + b²; el binomio al cubo (a + b)³ es el volumen de un cubo partido en a³ + 3a²b + 3ab² + b³ (ocho piezas imposibles de ver en 2D); los binomios conjugados (a + b)(a − b) son un cuadrado a² al que se le quita un cuadrado b², dando a² − b². Mueve los lados a y b y usa el control de separación para despiezar la figura y descubrir de dónde sale cada término (y por qué los coeficientes son 2 y 3). Acompaña el ejercicio de la plaza cuadrada (x + 5).",
    Component: LabProductos,
  },
  ...
  "modelado-conicas-estimacion": {
    ...
    descripcion:
      "Las cuatro secciones cónicas —circunferencia, elipse, parábola e hipérbola— no son cuatro curvas inconexas, sino los distintos cortes de un MISMO cono: lo que cambia es el ángulo con que el plano lo atraviesa. Este laboratorio lo hace tangible con un cono de doble napa y un plano de corte inclinable que puedes orbitar en 3D: con un control deslizante mueves el ángulo γ del plano y ves, en tiempo real, cómo el corte pasa de circunferencia (plano horizontal, 0°) a elipse (plano inclinado), a parábola (cuando el plano queda paralelo a una generatriz, 60°) y a hipérbola (cuando el plano corta las dos napas); en cada caso se rotula la cónica resultante con su ecuación canónica. Pero el propósito formativo es MODELAR Y ESTIMAR con ecuaciones de dos variables, así que el laboratorio incluye dos modelos reales que reproducen verbatim la actividad evaluable A2: una ANTENA PARABÓLICA y = 0.25·x² —que pasa por el punto (1, 0.25), de donde sale a = 0.25, y cuya altura a x = 2 es 0.25·4 = 1 m— con su FOCO en (0, 1) hacia el que convergen todos los rayos paralelos al eje (por eso las antenas DISH/SKY, los telescopios y los faros son parabólicos); y un MAPA DE COBERTURA x² + y² = 25 (radio de 5 km) donde se prueba la casa en (3, 4): como 3² + 4² = 9 + 16 = 25 = r², la casa cae justo en el BORDE del alcance —si x²+y² < 25 hay señal y si > 25 no la hay—. El reto evaluable pide hallar a, estimar la altura, escribir la ecuación de cobertura y clasificar la casa, los cuatro pasos del modelado: identificar la cónica, escribir su ecuación con los datos y usarla para estimar. Todos los cortes y los valores numéricos se calculan de forma exacta (parametrización del cono y del plano), así que las cónicas y las lecturas son reales. Acompaña la actividad de Pensamiento Matemático IV «Trigonometría y geometría analítica» sobre la aplicación de las secciones cónicas: modelado y estimación.",
    Component: LabModeladoConicas,
  },
  "lenguaje-algebraico-mosaicos": {
    slug: "lenguaje-algebraico-mosaicos",
    titulo: "Laboratorio 3D — Lenguaje algebraico con mosaicos",
    descripcion:
      "El álgebra empieza cuando una letra reemplaza a un número que no conocemos o que cambia: «el doble de un número, más tres» se escribe 2x + 3. Este laboratorio vuelve TANGIBLE ese lenguaje con mosaicos algebraicos en 3D —x² es un cuadrado de lado x, x una tira y la unidad un cuadrito—, así que cada expresión se ve como una fila de piezas (los términos negativos en rojo). Elige una frase verbal (incluido el área de un lote del INFONAVIT, x·(2x + 5) = 2x² + 5x) y mira cómo se traduce a símbolos y a mosaicos; luego mueve el control de x para EVALUAR la expresión para distintos valores y comprobar, por ejemplo, que 2x + 3 vale 17 cuando x = 7. El mismo visor abre también la clasificación de expresiones y la multiplicación de binomios. El reto evaluable pide traducir y evaluar tres frases —incluido el lote del INFONAVIT que da 102 m² con x = 6—, los pasos del modelado algebraico: identificar la incógnita, escribir la expresión y usarla. Acompaña a Pensamiento Matemático II «Introducción al álgebra».",
    Component: LabLenguajeAlgebraico,
  },
