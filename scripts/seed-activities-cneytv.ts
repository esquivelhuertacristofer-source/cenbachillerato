...
const contenidosA3 = [
  ...
  { // P02 — quiz_verdadero_falso (Cinemática: MRU, MRUA, caída libre)
    afirmaciones: [
      { enunciado: "En el MRU (Movimiento Rectilíneo Uniforme), la aceleración es cero y la gráfica posición-tiempo es una línea recta con pendiente igual a la velocidad.", valor: true, retroalimentacion: "VERDADERO. En el MRU, v = constante y a = 0. La ecuación es x = x₀ + vt (función lineal de t), por lo que la gráfica x-t es una línea recta con pendiente v. La gráfica v-t es una línea horizontal." },
      { enunciado: "En la caída libre, un objeto más pesado cae más rápido que uno más ligero (en ausencia de resistencia del aire).", valor: false, retroalimentacion: "FALSO. En ausencia de resistencia del aire, todos los objetos caen con la misma aceleración g ≈ 9.8 m/s², independientemente de su masa. Galileo demostró esto en el siglo XVI. La confusión viene de la experiencia cotidiana con resistencia del aire, que sí afecta diferente a objetos según su forma y densidad." },
      { enunciado: "Si un automóvil duplica su velocidad de 50 km/h a 100 km/h, su distancia de frenado también se duplica.", valor: false, retroalimentacion: "FALSO. La distancia de frenado es d = v₀²/(2a). Al duplicar la velocidad, la distancia se cuadruplica (2² = 4 veces más). A 50 km/h, d_freno ≈ 14 m (con desaceleración de 7 m/s²); a 100 km/h, d_freno ≈ 56 m. Por eso los límites de velocidad en zonas escolares son tan importantes." },
      { enunciado: "En el MRUA, la gráfica de velocidad en función del tiempo es una línea recta cuya pendiente es la aceleración.", valor: true, retroalimentacion: "VERDADERO. En el MRUA, v = v₀ + at es una ecuación lineal en t. La pendiente de la recta en la gráfica v-t es exactamente la aceleración a. Si a > 0, la recta sube; si a < 0 (desaceleración), la recta baja." },
      { enunciado: "Un objeto lanzado verticalmente hacia arriba desde el Estadio Azteca alcanza su punto más alto cuando su velocidad llega a cero y, en ese instante, su aceleración también es cero.", valor: false, retroalimentacion: "FALSO. En el punto más alto, la velocidad es cero (el objeto momentáneamente se detiene antes de comenzar a caer), pero la aceleración gravitacional sigue siendo g = 9.8 m/s² hacia abajo. La gravedad actúa continuamente, incluso cuando la velocidad es cero. Es un error común confundir velocidad nula con aceleración nula." },
      { enunciado: "El área bajo la curva de una gráfica velocidad-tiempo representa el desplazamiento recorrido.", valor: true, retroalimentacion: "VERDADERO. Matemáticamente, el desplazamiento es la integral de la velocidad respecto al tiempo: Δx = ∫v dt, que geométricamente es el área bajo la curva v-t. Para el MRU (rectángulo), Δx = v × t. Para el MRUA (triángulo o trapecio), el área da el desplazamiento total. Este principio es fundamental para analizar movimientos complejos con gráficas." },
    ],
    intentos_maximos: 2,
    puntaje_minimo_aprobacion: 70,
    mezclar_preguntas: false,
  ...
  { // P07 — quiz_verdadero_falso (Electromagnetismo)
    afirmaciones: [
      { enunciado: "Según la Ley de Ohm, si se duplica el voltaje aplicado a una resistencia (manteniendo R constante), la corriente también se duplica.", valor: true, retroalimentacion: "VERDADERO. V = IR → I = V/R. Si V se duplica y R es constante, I también se duplica. Ejemplo: si una resistencia de 100 Ω conectada a 12 V conduce 0.12 A, al conectarla a 24 V conducirá 0.24 A." },
      { enunciado: "Un generador eléctrico convierte energía mecánica en energía eléctrica usando el principio de inducción electromagnética descubierto por Faraday.", valor: true, retroalimentacion: "VERDADERO. Un generador hace girar bobinas de cobre dentro de un campo magnético; el flujo magnético cambiante induce una fuerza electromotriz (fem) que produce corriente alterna. La presa Chicoasén (CFE, Chiapas) y todas las centrales eléctricas del mundo usan este principio." },
      { enunciado: "Un motor eléctrico y un generador son fundamentalmente el mismo dispositivo, pero operando en sentido contrario.", valor: true, retroalimentacion: "VERDADERO. Ambos se basan en la interacción entre corriente eléctrica y campo magnético. El motor convierte energía eléctrica → mecánica (corriente en campo magnético genera movimiento). El generador convierte energía mecánica → eléctrica (movimiento en campo magnético induce corriente). Un mismo dispositivo físico puede funcionar como motor o generador dependiendo de cómo se use." },
      { enunciado: "La CFE transmite la electricidad a alta tensión (400 kV) para aumentar la corriente y llegar a más hogares simultáneamente.", valor: false, retroalimentacion: "FALSO. La alta tensión se usa para REDUCIR la corriente, no para aumentarla. A potencia constante (P = IV), mayor voltaje implica menor corriente. Las pérdidas por resistencia de los cables son P = I²R; al reducir I con alta tensión, las pérdidas en la transmisión disminuyen drásticamente. Luego los transformadores en subestaciones reducen el voltaje a 127-220 V para uso seguro." },
      { enunciado: "La corriente continua (DC) es la que usa la red eléctrica de los hogares mexicanos (127 V / 60 Hz).", valor: false, retroalimentacion: "FALSO. La red eléctrica doméstica en México distribuye corriente ALTERNA (AC) a 127 V y 60 Hz. Los 60 Hz significan que la corriente cambia de dirección 60 veces por segundo. La corriente continua (DC) es la de las baterías (celulares, automóviles). Los cargadores de celular y las fuentes de computadora convierten AC a DC internamente." },
      { enunciado: "En un transformador ideal, si el número de vueltas del secundario es el doble del primario, el voltaje de salida es el doble del voltaje de entrada.", valor: true, retroalimentacion: "VERDADERO. Razón de transformación: V₂/V₁ = N₂/N₁. Si N₂ = 2N₁, entonces V₂ = 2V₁. Este es un transformador elevador (step-up). Un transformador reductor (step-down) tiene N₂ < N₁ y reduce el voltaje. Los transformadores de CFE en las subestaciones son reductores: bajan de 400 kV a 23 kV, luego a 127 V en las acometidas domiciliarias." },
    ],
    intentos_maximos: 2,
    puntaje_minimo_aprobacion: 70,
    mezclar_preguntas: false,
