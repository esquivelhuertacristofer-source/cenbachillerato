...
type Modo = "armar" | "tipos" | "conectores";
...
export function LabTallerParrafos({ color }: PracticaLabProps) {
  ...
  const estrellas = (armarDone ? 1 : 0) + (tiposDone ? 1 : 0) + (conectoresDone ? 1 : 0);
  ...
  return (
    <div style={{ color: T.text }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap", marginBottom: 18 }}>
        ...
        <button
          className="tp-icobtn"
          onClick={modo === "armar" ? resetTexto : modo === "tipos" ? resetTipos : resetCon}
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
              ...
              <div style={{ textAlign: "right", maxWidth: 180 }}>
                <div style={{ fontSize: 11.5, color: T.text3, lineHeight: 1.45 }}>
                  {bestEstrellas >= 3 ? "¡Dominaste el párrafo!" : "Completa los tres modos para ganar las estrellas."}
                </div>
              </div>
            </div>
          </div>
