    ...
    preguntas: [
      {
        ...
        opciones: [
          { id: "a", texto: "Un libro de historia publicado en 2015 sobre el zapatismo" },
          { id: "b", texto: "Una fotografía del archivo Casasola tomada en 1914 durante la ocupación de la Ciudad de México" },
          { id: "c", texto: "Un documental sobre la Revolución emitido por el Canal 22 en 2010" },
          { id: "d", texto: "Un artículo académico sobre el Plan de Ayala publicado en Historia Mexicana" },
        ],
      ...
      },
      {
        ...
        opciones: [
          { id: "a", texto: "Autoría — revela quién produjo la fuente y sus credenciales" },
          { id: "b", texto: "Fecha — revela la distancia temporal entre producción y evento" },
          { id: "c", texto: "Intención — revela si la fuente es propaganda, documento oficial, uso personal u otro propósito que condiciona su contenido" },
          { id: "d", texto: "Audiencia — revela para quién fue pensada la fuente" },
        ],
      ...
      },
      {
        ...
        opciones: [
          { id: "a", texto: "Porque los historiadores siempre distorsionan sus fuentes por error o ignorancia" },
          { id: "b", texto: "Porque toda fuente refleja la perspectiva, los intereses y los límites del conocimiento de quien la produjo; identificar el sesgo no invalida la fuente sino que permite usarla críticamente" },
          { id: "c", texto: "Porque las fuentes escritas son siempre más confiables que las orales y visuales" },
          { id: "d", texto: "Porque solo las fuentes del gobierno son sesgadas; los testimonios personales son siempre objetivos" },
        ],
        respuesta_correcta: "b",
      ...
      },
      {
        ...
        opciones: [
          { id: "a", texto: "Un museo de arte colonial que exhibe pinturas del siglo XVI" },
          { id: "b", texto: "Un repositorio que conserva documentos primarios desde la época virreinal hasta el siglo XX: actas, expedientes judiciales, registros de la Reforma, documentos de la Revolución Mexicana y más" },
          { id: "c", texto: "Una biblioteca universitaria con colecciones de libros de historia académica" },
          { id: "d", texto: "Un archivo de noticias periodísticas digitalizadas del siglo XXI" },
        ],
        respuesta_correcta: "b",
      ...
      },
      {
        ...
        opciones: [
          { id: "a", texto: "Evaluar es más importante que interpretar; la interpretación es opcional" },
          { id: "b", texto: "Evaluar pregunta si la fuente es confiable y auténtica (aplicando criterios de autoría, fecha, intención, audiencia, contexto); interpretar pregunta qué nos dice sobre el pasado, qué información aporta y qué silencia" },
          { id: "c", texto: "Son sinónimos que describen la misma operación con palabras distintas" },
          { id: "d", texto: "Interpretar es un proceso previo a la evaluación: primero se lee la fuente y luego se decide si es confiable" },
        ],
        respuesta_correcta: "b",
      ...
      },
      {
        ...
        opciones: [
          { id: "a", texto: "El Instituto Nacional de Artes Históricas, dedicado exclusivamente a pintura colonial" },
          { id: "b", texto: "El Instituto Nacional de Antropología e Historia, que custodia patrimonio arqueológico y documentos coloniales, investiga la historia de México y regula la preservación del patrimonio cultural" },
          { id: "c", texto: "Una institución privada que vende reproducciones de documentos históricos" },
          { id: "d", texto: "Un organismo internacional de la UNESCO para la preservación de sitios históricos en América Latina" },
        ],
        respuesta_correcta: "b",
    ...
    preguntas: [
      {
        ...
        opciones: [
          { id: "a", texto: "La narrativa argumentada es más corta que el relato cronológico" },
          { id: "b", texto: "La narrativa argumentada construye una interpretación del pasado en torno a una tesis central, responde al por qué y al con qué consecuencias, y sostiene sus afirmaciones con evidencias; el relato cronológico solo describe lo que ocurrió en orden temporal" },
          { id: "c", texto: "El relato cronológico incluye tesis e interpretaciones; la narrativa argumentada solo usa fechas" },
          { id: "d", texto: "No hay ninguna diferencia: son formas equivalentes de hacer historia" },
        ],
        respuesta_correcta: "b",
      ...
      },
      {
        ...
        opciones: [
          { id: "a", texto: "Usar demasiadas fechas en la narrativa histórica" },
          { id: "b", texto: "Atribuir a actores del pasado ideas, valores o prácticas que no podían existir en su época" },
          { id: "c", texto: "Narrar eventos históricos en orden inverso al cronológico" },
          { id: "d", texto: "Comparar dos períodos históricos sin señalar sus diferencias" },
        ],
        respuesta_correcta: "b",
      ...
      },
      {
        ...
        opciones: [
          { id: "a", texto: "Porque todas las perspectivas históricas tienen el mismo valor como evidencia y deben incluirse por igual" },
          { id: "b", texto: "Porque un proceso histórico solo se comprende en su complejidad real si se considera cómo fue vivido y percibido por distintos grupos sociales (mujeres, indígenas, trabajadores, élites), sin reducirlo a la perspectiva del Estado o las élites" },
          { id: "c", texto: "Porque incluir más perspectivas hace que la narrativa sea más larga y académicamente rigurosa" },
          { id: "d", texto: "Porque los grupos subalternos siempre tienen la perspectiva más verdadera sobre los eventos históricos" },
        ],
        respuesta_correcta: "b",
      ...
      },
      {
        ...
        opciones: [
          { id: "a", texto: "Como listas numeradas aisladas: primero todas las causas, luego todas las consecuencias, sin conexión entre ellas" },
          { id: "b", texto: "Como encadenamientos argumentales: causas que se conectan unas con otras y consecuencias que a su vez se convierten en causas de procesos posteriores, mostrando la complejidad causal del proceso" },
          { id: "c", texto: "Omitiendo las causas y enfocándose solo en las consecuencias para simplificar el relato" },
          { id: "d", texto: "Identificando una sola causa principal y una sola consecuencia principal para mantener la narrativa clara" },
        ],
        respuesta_correcta: "b",
      ...
      },
      {
        ...
        opciones: [
          { id: "a", texto: "Que solo importa estudiar la historia reciente (los últimos 30 años) y no procesos del pasado lejano" },
          { id: "b", texto: "Que los procesos históricos del pasado no terminan: continúan operando en el presente bajo nuevas formas, como la desigualdad rural que el cardenismo intentó resolver y que reapareció con el levantamiento zapatista de 1994" },
          { id: "c", texto: "Que la historia del presente es más objetiva que la historia del pasado porque hay más fuentes disponibles" },
          { id: "d", texto: "Que los historiadores deben enfocarse solo en conectar eventos del presente con los más recientes, ignorando los procesos de largo plazo" },
        ],
        respuesta_correcta: "b",
      ...
      },
      {
        ...
        opciones: [
          { id: "a", texto: "Introducción, desarrollo, conclusión y bibliografía" },
          { id: "b", texto: "Título, índice, cuerpo del texto y notas al pie" },
          { id: "c", texto: "Tesis (interpretación central debatible), argumentos (razones que la sostienen), evidencias (fuentes y datos que respaldan cada argumento) y conclusión (retoma la tesis y evalúa el peso de los argumentos)" },
          { id: "d", texto: "Contexto histórico, descripción de eventos, lista de actores y fecha" },
        ],
        respuesta_correcta: "c",
